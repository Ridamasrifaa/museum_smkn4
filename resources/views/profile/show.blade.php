                ...
                <div class="flex-1 min-w-0 text-center sm:text-left space-y-3 sm:pt-4">
                    ...
                    <div class="flex flex-wrap justify-center sm:justify-start gap-2">
                        ...
                        @if(!empty($user->phone_number))
                            @php
                                // Normalisasi ke format internasional untuk link wa.me (08xxx -> 628xxx)
                                $waDigits = preg_replace('/\D/', '', $user->phone_number);
                                if (str_starts_with($waDigits, '0')) {
                                    $waDigits = '62' . substr($waDigits, 1);
                                }
                            @endphp
                            <a href="https://wa.me/{{ $waDigits }}" target="_blank" rel="noopener"
                               class="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-300 text-zinc-900 text-xs font-black rounded-xl border-2 border-zinc-900 shadow-[2px_2px_0px_#18181b] hover:bg-emerald-400 transition">
                                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.48 1.32 5L2 22l5.25-1.38a9.9 9.9 0 004.79 1.22h.01c5.46 0 9.91-4.45 9.91-9.91C21.96 6.45 17.51 2 12.04 2zm5.8 14.13c-.24.68-1.39 1.32-1.91 1.4-.5.08-1.09.1-1.75-.11a15.7 15.7 0 01-1.6-.59c-2.82-1.22-4.66-4.06-4.8-4.25-.14-.19-1.15-1.53-1.15-2.92s.72-2.07.98-2.35c.24-.28.53-.35.71-.35h.5c.16 0 .38-.06.6.46.24.57.8 1.98.87 2.12.07.14.11.31.02.5-.09.19-.14.31-.28.48-.14.16-.29.36-.42.48-.14.14-.28.29-.12.56.16.28.72 1.19 1.55 1.93 1.07.95 1.97 1.24 2.24 1.38.28.14.44.12.6-.07.17-.19.7-.82.89-1.1.19-.28.38-.23.63-.14.26.09 1.65.78 1.93.92.28.14.47.21.54.33.07.13.07.72-.17 1.4z"/>
                                </svg>
                                WhatsApp
                            </a>
                        @endif
